...
const Flashcard = ({ text, progress, onNext, onPrev }) => {
  ...
  return (
    <>
      <div ref={flashcardRef} className="w-[380px] h-[230px] mb-2">
        <div className="rounded-tl-2xl rounded-tr-2xl w-full h-2 bg-blue-900" style={{ width: `${progress * 100}%` }}></div>
        <div className=" bg-black flex w-full h-full bg-opacity-30 rounded-br-2xl rounded-bl-2xl justify-center items-center relative">
